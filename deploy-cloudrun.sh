...
# VayuDrishti Cloud Run Deployment Script
...
REGION="us-central1"
BACKEND_SERVICE="vayudrishti-backend"
FRONTEND_SERVICE="vayudrishti-frontend"
...
gcloud run deploy $FRONTEND_SERVICE \
  ...
  --cpu=1 \
  --max-instances=10 \
  --set-env-vars="VITE_API_URL=$BACKEND_URL,VITE_SUPABASE_URL=https://tmavkmymbdcmugunjtle.supabase.co,VITE_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRtYXZrbXltYmRjbXVndW5qdGxlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzQwMzAyMDYsImV4cCI6MjA4OTYwNjIwNn0.BEr2krViE54HjVtmm-WD6KV7cIcDQMOSmM-VyjiH7cY"
